...
public class Omikujiprogram {
    ...
    public static void omikujii() throws Exception {
        ...
        try {
            ...
            while ((line = br.readLine()) != null) {
                ...
                //それぞれの値をnewします。
                switch (values[0]) {
                    case "大吉" -> unsei = new Daikichi();
                    case "中吉" -> unsei = new Cyuukichi();
                    case "小吉" -> unsei = new Syoukichi();
                    case "吉" -> unsei = new Kichi();
                    case "末吉" -> unsei = new Sueyosi();
                    case "凶" -> unsei = new Kyou();
                    default -> {
                    }
                }
